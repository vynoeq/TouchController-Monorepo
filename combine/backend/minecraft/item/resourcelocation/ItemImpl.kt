package top.fifthlight.combine.backend.minecraft.item.resourcelocation

import net.minecraft.core.registries.BuiltInRegistries
import net.minecraft.world.item.Item
import top.fifthlight.combine.backend.minecraft.identifier.resourcelocation.toCombine
import top.fifthlight.combine.backend.minecraft.identifier.resourcelocation.toMinecraft
