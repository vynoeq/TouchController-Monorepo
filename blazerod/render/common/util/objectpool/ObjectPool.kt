package top.fifthlight.blazerod.render.common.util.objectpool

import top.fifthlight.blazerod.render.common.debug.ObjectPoolTracker
import java.util.*

private val pools = Collections.synchronizedSet(mutableSetOf<Pool<*>>())
private var cleaned = false
fun cleanupObjectPools() {
